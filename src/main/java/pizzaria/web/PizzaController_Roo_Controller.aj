...
privileged aspect PizzaController_Roo_Controller {
    ...
    public Collection<Cobertura> PizzaController.populateCoberturas() {
        return Cobertura.findAllCoberturas();
    }
    
    @ModelAttribute("massas")
    public Collection<Massa> PizzaController.populateMassas() {
        return Massa.findAllMassas();
    }
    
    String PizzaController.encodeUrlPathSegment(String pathSegment, HttpServletRequest request) {
